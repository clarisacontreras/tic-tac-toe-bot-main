...
#Estrategia ganadora 
    ...
    if board [1][0] == player_id and board [1][1] == player_id and board [1][2] == "-":
        return [1,2]
    if board [1][1] == player_id and board [0][1] == player_id and board [1][2] == "-":
        return [1,2]
    if board [2][0] == player_id and board [2][1] == player_id and board [2][2] == "-":
        return [2,2]
    if board [2][1] == player_id and board [2][0] == player_id and board [2][2] == "-":
        return [2,2]
    if board [0][0] == player_id and board [1][0] == player_id and board [2][0] == "-":
        return [2,0]
    if board [1][0] == player_id and board [0][0] == player_id and board [2][0] == "-":
        return [2,0]
    if board [0][1] == player_id and board [1][1] == player_id and board [2][1] == "-":
        return [2,1]
    if board [1][1] == player_id and board [0][1] == player_id and board [2][1] == "-":
        return [2,1]
    if board [0][2] == player_id and board [1][2] == player_id and board [2][2] == "-":
        return [2,2]
    if board [1][2] == player_id and board [0][2] == player_id and board [2][2] == "-":
        return [2,2]
    ...
    if board [1][2] == player_id and board [1][1] == player_id and board [1][0] == "-":
        return [1,0]
    if board [1][1] == player_id and board [1][2] == player_id and board [1][0] == "-":
        return [1,0]
    ...
    if board [2][2] == player_id and board [1][2] == player_id and board [0][2] == "-":
        return [0,2]
    if board [1][2] == player_id and board [2][2] == player_id and board [0][2] == "-":
        return [0,2]
    if board [0][0] == player_id and board [1][1] == player_id and board [2][2] == "-":
        return [2,2]
    if board [1][1] == player_id and board [0][0] == player_id and board [2][2] == "-":
        return [2,2]
    if board [2][2] == player_id and board [1][1] == player_id and board [0][0] == "-":
        return [0,0]
    if board [1][1] == player_id and board [2][2] == player_id and board [0][0] == "-":
        return [0,0]
    if board [2][0] == player_id and board [1][1] == player_id and board [0][2] == "-":
        return [0,2]
    if board [1][1] == player_id and board [2][0] == player_id and board [0][2] == "-":
        return [0,2]
    if board [0][2] == player_id and board [1][1] == player_id and board [2][0] == "-":
        return [2,0]
    if board [1][1] == player_id and board [0][2] == player_id and board [2][0] == "-":
        return [2,0]
...
#Estrategia de bloqueo 
    ...
    if board [1][0] == oponente and board [1][1] == oponente and board [1][2] == "-":
        return [1,2]
    if board [1][1] == oponente and board [0][1] == oponente and board [1][2] == "-":
        return [1,2]
    if board [2][0] == oponente and board [2][1] == oponente and board [2][2] == "-":
        return [2,2]
    if board [2][1] == oponente and board [2][0] == oponente and board [2][2] == "-":
        return [2,2]
    if board [0][0] == oponente and board [1][0] == oponente and board [2][0] == "-":
        return [2,0]
    if board [1][0] == oponente and board [0][0] == oponente and board [2][0] == "-":
        return [2,0]
    if board [0][1] == oponente and board [1][1] == oponente and board [2][1] == "-":
        return [2,1]
    if board [1][1] == oponente and board [0][1] == oponente and board [2][1] == "-":
        return [2,1]
    if board [0][2] == oponente and board [1][2] == oponente and board [2][2] == "-":
        return [2,2]
    if board [1][2] == oponente and board [0][2] == oponente and board [2][2] == "-":
        return [2,2]
    if board [0][2] == oponente and board [0][1] == oponente and board [0][0] == "-":
        return [0,0]
    if board [0][1] == oponente and board [0][2] == oponente and board [0][0] == "-":
        return [0,0]
    if board [1][2] == oponente and board [1][1] == oponente and board [1][0] == "-":
        return [1,0]
    if board [1][1] == oponente and board [1][2] == oponente and board [1][0] == "-":
        return [1,0]
    if board [2][2] == oponente and board [2][1] == oponente and board [2][0] == "-":
        return [2,0]
    if board [2][1] == oponente and board [2][2] == oponente and board [2][0] == "-":
        return [2,0]
    if board [2][0] == oponente and board [1][0] == oponente and board [0][0] == "-":
        return [0,0]
    if board [1][0] == oponente and board [2][0] == oponente and board [0][0] == "-":
        return [0,0]
    if board [2][1] == oponente and board [1][1] == oponente and board [0][1] == "-":
        return [0,1]
    if board [1][1] == oponente and board [2][1] == oponente and board [0][1] == "-":
        return [0,1]
    if board [2][2] == oponente and board [1][2] == oponente and board [0][2] == "-":
        return [0,2]
    if board [1][2] == oponente and board [2][2] == oponente and board [0][2] == "-":
        return [0,2]
    if board [0][0] == oponente and board [1][1] == oponente and board [2][2] == "-":
        return [2,2]
    if board [1][1] == oponente and board [0][0] == oponente and board [2][2] == "-":
        return [2,2]
    if board [2][2] == oponente and board [1][1] == oponente and board [0][0] == "-":
        return [0,0]
    if board [1][1] == oponente and board [2][2] == oponente and board [0][0] == "-":
        return [0,0]
    if board [2][0] == oponente and board [1][1] == oponente and board [0][2] == "-":
        return [0,2]
    if board [1][1] == oponente and board [2][0] == oponente and board [0][2] == "-":
        return [0,2]
    if board [0][2] == oponente and board [1][1] == oponente and board [2][0] == "-":
        return [2,0]
    if board [1][1] == oponente and board [0][2] == oponente and board [2][0] == "-":
        return [2,0]
